...
from poll import tabularise, save_rows, load_prev_rows, diff_tables, key_of
...
def test_full_workflow():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"   ✓ Loaded data matches saved data")
    ...
    print(f"   ✓ Diff works correctly (no changes detected for identical data)")
